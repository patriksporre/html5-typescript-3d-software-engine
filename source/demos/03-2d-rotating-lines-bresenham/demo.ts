 ...
 * 
 * Description:
 *   Demo 03-2d-rotating-lines-bresenham – demonstrates 2D transformation using rotation, scaling, and translation.
 ...
 *   The transformed points are then connected using lines (Bresenham) to create a rotating, pulsating wireframe square.
 */
...
export function render(blitter: Blitter, elapsedTime: number, deltaTime: number): void {
    ...
    for (let i: number = 0; i < transformed.length; i++) {
        ...
        blitter.drawLineBresenham(a, b, Color4.black);
    }
}